...
class EditProfileViewController: UIViewController, UITableViewDataSource {
    ...
    private func createTableHeaderView() -> UIView {
        ...
        profilePhotoButton.setBackgroundImage(UIImage(systemName: "person.cirle"), for: .normal)
    ...
    @objc private func didTapChangeProfilePicture() {
        let actionSheet = UIAlertController(title: "Profile Pictures", message: "Change Profile Picture", preferredStyle: .actionSheet)
